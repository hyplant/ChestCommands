...
public enum AttributeType {
    ...
    POSITION_Y("POSITION-Y", ConfigType.INTEGER, PositionAttribute::new), MATERIAL("MATERIAL", ConfigType.STRING, MaterialAttribute::new),
    DURABILITY("DURABILITY", ConfigType.SHORT, DurabilityAttribute::new), AMOUNT("AMOUNT", ConfigType.INTEGER, AmountAttribute::new),
    NAME("NAME", ConfigType.STRING, NameAttribute::new), LORE("LORE", ConfigType.STRING_LIST, LoreAttribute::new),
    NBT_DATA("NBT-DATA", ConfigType.STRING, NBTDataAttribute::new), LEATHER_COLOR("COLOR", ConfigType.STRING, LeatherColorAttribute::new),
    ...
    PRICE("PRICE", ConfigType.DOUBLE, PriceAttribute::new), EXP_LEVELS("LEVELS", ConfigType.INTEGER, ExpLevelsAttribute::new),
    ...
    KEEP_OPEN("KEEP-OPEN", ConfigType.BOOLEAN, KeepOpenAttribute::new), ACTIONS("ACTIONS", ConfigType.STRING_LIST, ActionsAttribute::new),
    ...
    static {
        ...
        for (final AttributeType attributeParser : AttributeType.values()) {
            AttributeType.attributeTypeByConfigKey.put(attributeParser.getConfigKey(), attributeParser);
        }
    }
    ...
    <V> AttributeType(final String configKey, final ConfigType<V> configType, final AttributeFactory<V, ?> attributeFactory) {
        this.configKey = ConfigPath.literal(configKey);
        this.attributeParser = (final ConfigValue configValue, final AttributeErrorHandler errorHandler) -> attributeFactory
                .create(configValue.asRequired(configType), errorHandler);
    }

    public ConfigPath getConfigKey() { return this.configKey; }

    public AttributeParser getParser() { return this.attributeParser; }

    public static AttributeType fromConfigKey(final ConfigPath configKey) { return AttributeType.attributeTypeByConfigKey.get(configKey); }
